...
/* Step 2: Create several functions to callback with consume();
  ...
  * Create a function named greeting that accepts a first
  *  and last name and returns "Hello 
...
function multiply ( num1, num2){
 ...
 function greeting (firtsname, lastname){
  return `${firtsname}, ${lastname} nice to meet you!`
 }
...
// Explanation: The scope of a nested function is inside the enclosing function.
